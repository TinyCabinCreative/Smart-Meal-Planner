...
export {}
declare global {
  const IngredientOptimizer: typeof import('../../utils/ingredientOptimizer').IngredientOptimizer
...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { IngredientOptimizer } from '../../utils/ingredientOptimizer'
  import('../../utils/ingredientOptimizer')
}
// for vue template auto import
import { UnwrapRef } from 'vue'
declare module 'vue' {
  interface ComponentCustomProperties {
    readonly IngredientOptimizer: UnwrapRef<typeof import('../../utils/ingredientOptimizer')['IngredientOptimizer']>
